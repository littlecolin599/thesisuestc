...
图\ref{DPEN_framework}是基于双通道注意力的极化SAR目标分类算法示意图。该方法构建了端到端的极化特征校准与分类网络结构，以挖掘多类型极化特征中的隐藏信息为目的，基于极化SAR数据中的后向散射特征与目标分解特征的差异性与互补性，实现两类型极化特征的信息提取与有效融合，提升目标分类准确率。
