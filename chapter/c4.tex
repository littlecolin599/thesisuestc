...
为了验证本章方法的优越性能，选择了多种替代的分类方案进行比较，主要是通过与目前经典的以及优越的分类方法进行对比，包括支持向量机方法（记为SVM）\citing{lardeux2009support}、基于Wishart分布的分类方法（记为Wishart）\citing{kong1988identification}和鲁棒的半监督学习方法（记为RSL）\citing{hou2017robust}。
